...
def fuzz_header_type_opcode(self, session_kwargs: dict = {}):
    ...
    3.) Mark the test case as crash if the returned value is not zero.
        In difference to the Basys3 board BIT29_BAD_PACKET_ERROR in the status register is not set.
