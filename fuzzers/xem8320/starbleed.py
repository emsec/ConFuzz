...
def fuzz_starbleed(self, session_kwargs: dict = {}):
    ...
    This mask is XORed to 40 words of the specified bitstream starting at the first encrypted word (byte 284).
    ...
    session.add_target(
        self._get_target(
            ...
            sleep_after_fuzz=CONSTANTS.BOARD_CONSTANTS.RESTART_DELAY,
    ...
    starbleed_request = Request(
        ...
        children=(
            FuzzedBitstream(
                ...
                fuzzing_position=FuzzPosition(index_start=284, word_count=40),
            )
        ),
    )
