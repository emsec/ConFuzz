...
def fuzz_playground(self, session_kwargs: dict = {}):
    ...
    custom_register_settings = {
        ...
        "register16": {
            "crash_if_differs_from_default": "no",
            "crash_if_not_equal_to_transmitted": "playground_request.fuzzed_far_value",
        },
    }
    ...
    playground_request = Request(
        ...
        children=(
            Type1WritePacket(name="write_to_ws", register_address=16),
            BitstreamWord(
                name="fuzzed_far_value",
                static_bits=0x00000000,
                fuzzing_mask=0x0000FFFF,
            ),
            ...
            Static(name="far", default_value=b"\x00\x00\x00\x00"),
...
def fuzz_enc_bitfile_playground(self, session_kwargs: dict = {}):
    ...
    custom_register_settings = {
        "register1": {
            "crash_if_differs_from_default": "no",
            "crash_if_not equal_to": "00 00 00 00",
        },
        "register5": {
            "crash_if_differs_from_default": "no",
